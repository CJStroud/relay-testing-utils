...
export default function relayWrap(component, relayOptions){
  ...
  const relaySpec = {
    forceFetch: jest.jn(),
    getPendingTransactions: jest.jn().mockImplementation(() => relayOptions.pendingTransactions),
    hasOptimisticUpdate: jest.jn().mockImplementation(() => relayOptions.hasOptimisticUpdate),
